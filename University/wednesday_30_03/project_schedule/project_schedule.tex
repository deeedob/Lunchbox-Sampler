...
There are three main subprojects that will form the whole project as well as three different project stages in order to roughly structure the overall time available. The work packages are each assigned a subproject and a stage. The relations are shown further down in the charts by color and text.
